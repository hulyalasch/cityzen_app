...
def main():
    ...
    # Display selected features within each category
    for category, data in categories.items():
        ...
        selected_features = st.multiselect("Select features", buttons, [])
        if selected_features:
            selected_features_placeholder.text(f"Selected Features: {', '.join(selected_features)}")
            st.session_state['selected_features'].extend(selected_features)
